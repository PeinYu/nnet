 ...
 * algorithm.
 */
public class MlPerceptronLineBinOutput extends MlPerceptron {
    
    public MlPerceptronLineBinOutput(TransferFunctionType transferFunctionType, int... neuronsInLayers) {
    ...
    protected void createNetwork(List<Integer> neuronsInLayers, NeuronProperties neuronProperties) {
        ...
        for (layerIdx = 1; layerIdx < neuronsInLayers.size()-1; layerIdx++) {
            ...
            // 中间层，传输函数为Line
            neuronProperties.put("transferFunction", org.neuroph.core.transfer.Linear.class);
        ...
        outProperties.put("transferFunction.yLow", -1);
